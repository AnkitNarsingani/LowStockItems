		...
		<div
				...
				<>
					...
					<div className="px-3.5 py-2.5 border-r border-line min-w-0">
						<input
							...
							placeholder="0.00"
							className="num w-full min-w-0 h-[34px] border border-line-2 rounded-lg px-2.5 text-right text-[13.5px] outline-none bg-surface transition-shadow hover:border-muted-4 focus:border-brand"
						/>
					</div>
			...
			{line.item_id && (
				<button
					...
					className="absolute right-[-76px] top-1/2 -translate-y-1/2 w-7 h-7 rounded-md border border-line-2 bg-surface flex items-center justify-center cursor-pointer text-body-3 hover:bg-brand-50 hover:border-brand-300 hover:text-brand-600">
