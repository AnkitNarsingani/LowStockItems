	...
	return (
		<div
			...
			<div
				...
				aria-modal="true"
				aria-label={title}
				className="w-[420px] max-w-full bg-surface rounded shadow-[0_24px_60px_rgba(10,20,40,.35)] overflow-hidden">
				<div className="px-5 pt-5 pb-4">
					<div className="flex items-start gap-3">
						<span className="w-9 h-9 rounded-full bg-red-50 border border-danger-border flex items-center justify-center flex-shrink-0">
							<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#e0322b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
